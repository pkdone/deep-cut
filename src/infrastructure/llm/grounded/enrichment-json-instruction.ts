...
export const ENRICHMENT_JSON_INSTRUCTION = [
  ...
  'When evidence presents a finite core studio discography, include the full core set in rankedAlbums rather than only a subset.',
  ...
  'For artists with known live or compilation releases, include at least one entry in the appropriate list(s) when evidence mentions them. Only leave liveAlbums/bestOfCompilations/raritiesCompilations empty when evidence truly provides none.',
